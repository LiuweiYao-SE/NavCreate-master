f_output = open("out.html", 'w', encoding='utf-8')  # 输出文件夹
f_text = open("text.txt", 'r', encoding='utf-8')  # 输入文件夹
title = "CloudPlayer网址导航"  # 网页title
long_logo = "../assets/images/logo@2x.png"  # 长条 logo
logo = "../assets/images/favicon.png"  # logo
favicon = "../assets/images/favicon.ico"  # favicon
"""网站, 图标, 名字, 描述"""
...
def h_n_all(n, title):
    n = str(n)
    return '<h' + n + """ class="text-gray"><i class="linecons-tag" style="margin-right: 7px;" id=\"""" + title + """"></i>""" + title + '</h' + n + '>'
